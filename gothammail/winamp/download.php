...
function insertBodyPart($imap, $messageNo, $thisStructure, $email_id, $part_number = "0"){
	...
	$sql = "INSERT INTO winamp_email_bodies (email_id, part_number, type, encoding, subtype, description, idstring, numlines, bytes, disposition, dparameters, parameters, filename, body)
